...
The charts below illustrate the memory consumption of both approaches,
for a big zip archive.
...
This is because Astro, similarly to Next.js, support serverless deployments.
...
[How to stream files from Astro Server Endpoints - ericburel.tech](https://www.ericburel.tech/blog/nextjs-stream-files)
...
[Astro official doc about streaming in Server Endpoints](https://nextjs.org/docs/app/building-your-application/routing/route-handlers#streaming)

[next/after announcement](https://nextjs.org/blog/next-15-rc#executing-code-after-a-response-with-nextafter-experimental)

[Vercel waitUntil](https://vercel.com/changelog/waituntil-is-now-available-for-vercel-functions)

[Cloudflare waitUntil](https://developers.cloudflare.com/workers/runtime-apis/context/)

[next/after](https://nextjs.org/docs/app/api-reference/functions/unstable_after), 
